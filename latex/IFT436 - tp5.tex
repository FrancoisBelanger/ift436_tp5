...
\newline
Les algorithmes codés de Prim et Kruskal sur Internet. Quant à Bor\r{u}vka, aucun code acceptable a été trouvé, donc il a été codé. Une classe DisjointSet a été créé pour les algoritmes Bor\r{u}vska et Krustal.\\
...
Le générateur de graphe a été construit selon la documenttation trouvé sur Internet: \textit{https://en.wikipedia.org/wiki/Mersenne\_Twister}. Dans le code du générateur de graphe, la fonction «random» de Python est utilié. 
